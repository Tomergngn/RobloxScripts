getgenv().settin = {
    ...
    ['MinimumWithdrawAmount'] = 500, -- fake withdraw amount
    ['Beg'] = {
        ['Delay'] = 30,
        ['Messages'] = {
            '💎 WIN BOBUX HERE 💎',
...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Tomergngn/RobloxScripts/main/PlsDonateCasinoAFK.lua'))()")
...
local text = [[
<stroke color="#444444" thickness="1"><font size="9"><font color= "#FFB300"><font face="DenkOne">💸 LOADING THE CASINO 💸</font></font></font></stroke>
]]
...
msgdone.OnClientEvent:Connect(function(msgdata)
	...
	if message == 'hello' then
		if plrchatted:DistanceFromCharacter(game:GetService('Players').LocalPlayer) <= 20 then
			chat('💸 Hello! Type "$help" to start playing! 💸')
		end
	end
	if message == 'hi' then
		if plrchatted:DistanceFromCharacter(game:GetService('Players').LocalPlayer) <= 20 then
			chat('💸 Hi! Type "$help" to start playing! 💸')
		end
	end
	if message == 'how' then
		if plrchatted:DistanceFromCharacter(game:GetService('Players').LocalPlayer) <= 20 then
			chat('💸 Type "$help" to start playing! 💸')
		end
	end
...
task.spawn(function()
	while true do
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="13"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸<br />------💸-Golden Casino-💸<br />💸        $help to play        💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="13"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸<br />-----💸-Golden Casino-💸-<br />💸        $help to play        💸</font></font></font></stroke>', "booth")
		task.wait(3)
		boothText:FireServer('<stroke color="#444444" thickness="1"><font size="13"><font color= "#FFB300"><font face="DenkOne">💸         Win Bobux!         💸<br />----💸-Golden Casino-💸--<br />💸        $help to play        💸</font></font></font></stroke>', "booth")
